package corejava.voumeII.chapter01.randomAccess2;
...
public class RandomAccessTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path path = ClassPathUtils.getResourceAsPath(RandomAccessTest.class, "employee.dat");
    ...
    */
    public static void writeData(ByteBuffer out, Employee e) {
    ...
    /**
       ...
       @return the employee
    */
    public static Employee readData(ByteBuffer in) {
