package corejava.voumeII.chapter05.dateFormat;
...
class DateFormatFrame extends JFrame {
    ...
    private static final long serialVersionUID = 6644415304912648266L;
    ...
    public DateFormatFrame() {
        ...
        add(new JLabel("Date style"), new GBC(0, 1).setAnchor(GridBagConstraints.EAST));
        add(new JLabel("Time style"), new GBC(2, 1).setAnchor(GridBagConstraints.EAST));
        add(new JLabel("Date"), new GBC(0, 2).setAnchor(GridBagConstraints.EAST));
        add(new JLabel("Time"), new GBC(0, 3).setAnchor(GridBagConstraints.EAST));
        add(localeCombo, new GBC(1, 0, 2, 1).setAnchor(GridBagConstraints.WEST));
        add(dateStyleCombo, new GBC(1, 1).setAnchor(GridBagConstraints.WEST));
        add(timeStyleCombo, new GBC(3, 1).setAnchor(GridBagConstraints.WEST));
        add(dateParseButton, new GBC(3, 2).setAnchor(GridBagConstraints.WEST));
        add(timeParseButton, new GBC(3, 3).setAnchor(GridBagConstraints.WEST));
        add(lenientCheckbox, new GBC(0, 4, 2, 1).setAnchor(GridBagConstraints.WEST));
        add(dateText, new GBC(1, 2, 2, 1).setFill(GridBagConstraints.HORIZONTAL));
        add(timeText, new GBC(1, 3, 2, 1).setFill(GridBagConstraints.HORIZONTAL));
