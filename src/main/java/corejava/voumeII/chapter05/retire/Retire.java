...
class RetireFrame extends JFrame {
    ...
    private static final long serialVersionUID = 6700440786374334614L;
    ...
    public RetireFrame() {
        ...
        add(languageLabel, new GBC(0, 0).setAnchor(GridBagConstraints.EAST));
        add(savingsLabel, new GBC(0, 1).setAnchor(GridBagConstraints.EAST));
        add(contribLabel, new GBC(2, 1).setAnchor(GridBagConstraints.EAST));
        add(incomeLabel, new GBC(4, 1).setAnchor(GridBagConstraints.EAST));
        add(currentAgeLabel, new GBC(0, 2).setAnchor(GridBagConstraints.EAST));
        add(retireAgeLabel, new GBC(2, 2).setAnchor(GridBagConstraints.EAST));
        add(deathAgeLabel, new GBC(4, 2).setAnchor(GridBagConstraints.EAST));
        add(inflationPercentLabel, new GBC(0, 3).setAnchor(GridBagConstraints.EAST));
        add(investPercentLabel, new GBC(2, 3).setAnchor(GridBagConstraints.EAST));
        add(localeCombo, new GBC(1, 0, 3, 1));
        add(savingsField, new GBC(1, 1).setWeight(100, 0).setFill(GridBagConstraints.HORIZONTAL));
        add(contribField, new GBC(3, 1).setWeight(100, 0).setFill(GridBagConstraints.HORIZONTAL));
        add(incomeField, new GBC(5, 1).setWeight(100, 0).setFill(GridBagConstraints.HORIZONTAL));
        add(currentAgeField, new GBC(1, 2).setWeight(100, 0).setFill(GridBagConstraints.HORIZONTAL));
        add(retireAgeField, new GBC(3, 2).setWeight(100, 0).setFill(GridBagConstraints.HORIZONTAL));
        add(deathAgeField, new GBC(5, 2).setWeight(100, 0).setFill(GridBagConstraints.HORIZONTAL));
        add(inflationPercentField, new GBC(1, 3).setWeight(100, 0).setFill(GridBagConstraints.HORIZONTAL));
        add(investPercentField, new GBC(3, 3).setWeight(100, 0).setFill(GridBagConstraints.HORIZONTAL));
        add(retireCanvas, new GBC(0, 4, 4, 1).setWeight(100, 100).setFill(GridBagConstraints.BOTH));
        add(new JScrollPane(retireText), new GBC(4, 4, 2, 1).setWeight(0, 100).setFill(GridBagConstraints.BOTH));
    ...
    public void setCurrentLocale(Locale locale) {
        ...
        res = ResourceBundle.getBundle("corejava.voumeII.chapter05.retire.RetireResources", currentLocale);
        resStrings = ResourceBundle.getBundle("corejava.voumeII.chapter05.retire.RetireStrings", currentLocale);
...
class RetireComponent extends JComponent {
    ...
    private static final long serialVersionUID = -8615816197146115093L;
