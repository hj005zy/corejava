package corejava.voumeII.chapter05.numberFormat;
...
class NumberFormatFrame extends JFrame {
    ...
    private static final long serialVersionUID = 8431155770045172120L;
    ...
    public NumberFormatFrame() {
        ...
        add(numberText, new GBC(1, 2).setFill(GridBagConstraints.HORIZONTAL));
